...
import ir.sep.android.merchantapp.databinding.MenuSettingItemBinding;
...
public class MenuAdapter extends ListAdapter<Menu, MenuViewHolder> {
    ...
    public MenuViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new MenuViewHolder(DataBindingUtil.inflate(LayoutInflater.from(parent.getContext()), R.layout.menu_setting_item, parent, false),
                listener);
    }
...
class MenuViewHolder extends RecyclerView.ViewHolder {
    ...
    private MenuSettingItemBinding binding;
    private MenuListener listener;

    public MenuViewHolder(@NonNull MenuSettingItemBinding binding, MenuListener listener) {
